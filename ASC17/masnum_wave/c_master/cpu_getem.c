...
void mean1_inner_()
{
    ...
    for(i = 0; i < mean1_group_count; i++)
    {
        ...
        host_flag[PACKED_PTR] = mean1_packed_float;
        host_flag[INDEXS_PTR] = mean1_packed_int;
        host_flag[OUT_DATA_PTR] = mean1_out_buffer;
        host_flag[IAS_PTR] = mean1_ia_set;
        host_flag[ICS_PTR] = mean1_ic_set;
        host_flag[NSPS_PTR] = mean1_nsp_set;
